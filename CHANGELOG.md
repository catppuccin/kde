...
- `-n`/`--no-cursor` flag to skip cursor installation (#146)

### Changed

- color schemes, splash screens, and look-and-feel metadata are now rendered ahead of time by Whiskers and checked into the repo, instead of generated by `sed` at install time; `install.sh` only ever reads the pre-built output (#149)
...
[Unreleased]: https://github.com/catppuccin/kde/compare/v0.4.0...HEAD
[0.4.0]: https://github.com/catppuccin/kde/compare/v0.3.1...v0.4.0
